...
const Footer=()=>{
    return(
        <div className="w-full bg-black p-1 z-10 mt-12">
            <div className="grid grid-cols-1 gap-x-24 sm:grid-cols-2 lg:grid-cols-4 sm:gap-y-44 mt-12">
                <div className="w-36 h-24 ml-10">
                    <h2 className="font-bold font-sans text-3xl text-white">Cabio</h2>
                   
                    <p className="font-bold font-sans text-sm text-white">Ride with us!</p>
                </div>
